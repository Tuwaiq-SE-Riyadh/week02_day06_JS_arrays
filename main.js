...
var names = map_to_names(characters);
console.log("array of all names: [" + names.join(" , ") + "] <br>");

var heights = characters.map(
	(char) => {
		return char.height;
	}
	);
...
var eyecolors = characters.reduce(
		(acc, cur) => {
...
for (var key of Object.keys(eyecolors)) {
    console.log(key + ": " + eyecolors[key]+", ");
}
console.log("</br>");
...
var lessthan200 = characters.filter(
    (char) => {
...
var sorted_mass = characters.sort(
    (a,b) => {
...
var height_mass = characters.sort(
    (a,b) => {
...
var check1 = characters.every((char)=> {return char.mass > 40;});
console.log("Does every character have mass more than 40?: " + check1 + "<br>");

var check2 = characters.every((char)=> {return char.height < 200;});
...
var check3 = characters.some((char)=> {return char.eye_color == 'blue';});
console.log("Is there at least one character with blue eyes?: " + check3 + "<br>");

var check4 = characters.some((char)=> {return char.height > 210;});
